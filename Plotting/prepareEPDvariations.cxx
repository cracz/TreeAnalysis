...
void prepareEPDvariations()
{
  ...
  //TFile* sourceFile = TFile::Open("eventPlaneSystematics_3p9GeV_1to5_max10_SL23e.root","READ");
  TFile* sourceFile = TFile::Open("eventPlaneSystematics_4p5GeV_1to3_max9_SL23e.root","READ");
